...
def main() -> None:
    ...
    fig.savefig(ROOT / "deposits_boxplot.png", bbox_inches="tight", dpi=600)
    fig.savefig(ROOT / "deposits_boxplot.pdf", bbox_inches="tight")
    fig.savefig(ROOT / "deposits_boxplot.eps", bbox_inches="tight")
