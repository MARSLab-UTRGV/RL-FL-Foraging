...
def main() -> None:
    ...
    fig.savefig(ROOT / "exp2_percentage_boxplot.png", bbox_inches="tight", dpi=600)
    fig.savefig(ROOT / "exp2_percentage_boxplot.pdf", bbox_inches="tight")
    fig.savefig(ROOT / "exp2_percentage_boxplot.eps", bbox_inches="tight")
