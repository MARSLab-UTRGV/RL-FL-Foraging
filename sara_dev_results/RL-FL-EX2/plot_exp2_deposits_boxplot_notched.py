...
def main() -> None:
    ...
    fig.savefig(ROOT / "exp2_deposits_boxplot_notched.png", bbox_inches="tight", dpi=600)
    fig.savefig(ROOT / "exp2_deposits_boxplot_notched.pdf", bbox_inches="tight")
    fig.savefig(ROOT / "exp2_deposits_boxplot_notched.eps", bbox_inches="tight")
