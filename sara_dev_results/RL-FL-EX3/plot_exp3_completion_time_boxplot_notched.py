...
def main() -> None:
    ...
    for group_index in range(len(DISTRIBUTIONS)):
    ...
    fig.savefig(ROOT / "exp3_completion_time_boxplot_notched.png", bbox_inches="tight", dpi=600)
    fig.savefig(ROOT / "exp3_completion_time_boxplot_notched.pdf", bbox_inches="tight")
    fig.savefig(ROOT / "exp3_completion_time_boxplot_notched.eps", bbox_inches="tight")
