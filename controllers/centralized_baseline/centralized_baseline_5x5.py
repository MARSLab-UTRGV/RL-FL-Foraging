...
class CentralizedBaseline(Supervisor):
    def __init__(self):
        ...
        self.grid_size      = 50
        self.grid_res       = 5.0 / self.grid_size        # 0.1 m per cell
    ...
    #   robot covers the 5×5m arena rather than hovering near the centre.
    # =========================================================================
    def _new_explore_target(self, robot_pos):
        angle = random.uniform(0.0, 2.0 * math.pi)
        dist  = random.uniform(0.8, 2.3)
            ...
            for i in range(self.num_robots):
                ...
                # ----------------------------------------------------------
                    ...
                    # ----------------------------------------------------------
                        ...
                        cluster_x = peak[0] * self.grid_res - 2.5
                        cluster_y = peak[1] * self.grid_res - 2.5
                        ...
                        #                 wx = gx * self.grid_res - 2.5
                        #                 wy = gy * self.grid_res - 2.5
