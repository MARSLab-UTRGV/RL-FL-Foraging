...
if __name__ == "__main__":
    ...
    print(f"[TRAINING] Training on {device}")
    ...
    model = PPO(
        ...
        tensorboard_log="./tb_epuck_top5_smallbatch2M/"
    )
    
    checkpoint_callback = CheckpointCallback(
        save_freq=100000,
        save_path='./logs_epuck_top5_smallbatch2M/',
        name_prefix='ppo_epuck_top5_smallbatch2M'
    )
    
    print("[TRAINING] Starting PPO Training with Reward Shaping...")
    model.learn(total_timesteps=2000000, callback=checkpoint_callback)
    
    model.save("ppo_epuck_top5_smallbatch2M")
    print("[PICKUP] Training Complete. Model saved.")
