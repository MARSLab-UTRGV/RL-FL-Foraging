...
if __name__ == "__main__":
    print("="*60)
    print("HEADLESS BATCH MODE - MAXIMUM SPEED")
    print("="*60)
    ...
    print("Creating HEADLESS model...")
    model = PPO(
        "MlpPolicy", 
        env, 
        verbose=1, 
        tensorboard_log="./ppo_headless_tensorboard/",
    ...
    print("\n" + "="*60)
    print("STARTING HEADLESS TRAINING (300K TIMESTEPS)")
    print("="*60 + "\n")
