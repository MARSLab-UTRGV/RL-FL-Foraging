...
if __name__ == "__main__":
    print("="*60)
    print("FAST MODE 2M TIMESTEPS TRAINING")
    print("="*60)
    ...
    print("Creating new 2M model...")
    model = PPO(
        "MlpPolicy", 
        env, 
        verbose=1, 
        tensorboard_log="./ppo_2M_tensorboard/",
    ...
    print("\n" + "="*60)
    print("STARTING 2 MILLION TIMESTEP TRAINING")
    print(f"Total Timesteps: 2,000,000")
    print(f"Estimated Updates: {2000000 // 4096}")
    print("="*60 + "\n")
    
    model.learn(total_timesteps=2000000)
    model.save(model_path)
    
    print("\n2M TRAINING COMPLETE!")
